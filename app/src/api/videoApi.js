...
export const getVideoSubscriptionApi = (page) => {
  return axiosClient.get(`/api/video/subscription/video-subscription?page=${page}`);
};
...
export const getVideoTrendingApi = () => {
  return axiosClient.get("/api/video/trend/trending");
};
