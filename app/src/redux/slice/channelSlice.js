...
import { getChannelInfoApi, getChannelVideoApi, updateUserApi } from "../../api/channelApi";
...
export const getChannelInfo = createAsyncThunk("channel/profile", async (id) => {
  const res = await getChannelInfoApi(id);
  return res.data;
});

export const getChannelVideo = createAsyncThunk("channel/videos", async ({ id, page }) => {
...
export const deleteVideo = createAsyncThunk("channel/deleteVideo", async (id) => {
  await deleteVideoApi(id);
  return id;
});

export const editVideo = createAsyncThunk("channel/editVideo", async ({ id, data }) => {
