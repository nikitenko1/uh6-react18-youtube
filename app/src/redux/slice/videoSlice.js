...
export const checkLike = createAsyncThunk("video/check-like", async (videoId) => {
...
export const checkDisLikeVideo = createAsyncThunk("video/checkDislike", async (videoId) => {
  const res = await checkDisLikeVideoApi(videoId);
  return res.data;
});

export const unDisLikeVideo = createAsyncThunk("video/unDisLikeVideo", async (videoId) => {
...
const videoSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getVideoById.fulfilled, (state, action) => {
      ...
      state.loading = false;
      state.videoRecommend = action.payload.videoRecommend;
